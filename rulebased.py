...
np.save("models/rulebased_rewards.npy", np.array(reward_list))
...
# np.save("models/rulebased_1_episode_rewards_breakdown.npy", np.array(rewards_breakdown_per_episode))